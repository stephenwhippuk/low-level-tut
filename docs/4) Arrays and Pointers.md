...
Ignoring the details, the following diagram illustrates this in memory:
...
## Using Arrays 
Having defined the above array, this allows us to write something like the following to access the values sequentially
